...
function AdminNursesPageContent() {
  ...
  const fetchNurses = async () => {
    try {
      ...
      setError(err.message || "Unable to load nurse records.");
      setRecords([]);
    } finally {
      setLoading(false);
    }
  ...
  const titleMap: Record<string, string> = {
    pending: "Pending Nurse Requests",
    approved: "Approved Nurses",
    rejected: "Rejected Nurses",
    all: "All Nurse Records",
  };
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            <div>
              ...
              <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">
                {titleMap[status] || "Nurse Records"}
              </h1>
              <p className="text-slate-500 font-medium mt-2">
                View and manage nurse records across the platform.
              </p>
            </div>
            ...
            {loading ? (
              ...
              <div className="bg-white p-12 rounded-3xl border border-dashed border-slate-300 text-center text-slate-500">
                No nurse records found for this filter.
              </div>
            ) : (
              <div className="grid gap-5">
                {filteredRecords.map((nurse, index) => (
                  <motion.div
                    key={nurse._id}
                      ...
                      <div className="flex-1 grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-slate-900 capitalize">
                            {nurse.verificationStatus || "Not available"}
                          </p>
                        </div>
